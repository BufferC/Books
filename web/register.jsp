        ...
        <div id="register">
            ...
            <form method="post" action="register" onsubmit="return check()"  >
                <dl>
                    ...
                    <dt>密　　码：</dt>
                    <dd><input class="input-text" type="password" id="password" name="password" onblur="isPasswordLegal()" /><span id="nullpassword"><span color=\"green\">密码至少8位</span></span><span id="simplepassword"></span></dd>
                    <dt>确认密码：</dt>
